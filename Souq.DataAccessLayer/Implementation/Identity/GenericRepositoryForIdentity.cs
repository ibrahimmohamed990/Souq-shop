...
{
    public class GenericRepositoryForIdentity<T> : IGenericRepository<T> where T : IdentityUser
    {
        private readonly IdentityUserDbContext _context;
        private DbSet<T> _dbSet;

        public GenericRepositoryForIdentity(IdentityUserDbContext context)
        {
            _context = context;
